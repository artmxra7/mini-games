...
const GamesNavBarComponent = () => {
  ...
  return (
    <Drawer
      ...
      anchor="left"
    >
      <CardActionArea onClick={() => browserHistory.push("/")}>
        <CardMedia
          component="img"
          alt="MiniGames logo"
          image={miniGamesLogo}
      ...
      <List>
        <ListItem onClick={() => browserHistory.push("/spin")}>
          <ListItemAvatar>
            <Avatar
              alt="Spin a wheel to try your luck"
              src={spinPrizeWheelLogo}
            />
          </ListItemAvatar>
          <ListItemText
            primary="Spin a wheel"
            secondary="Try your luck today"
          />
        </ListItem>
        <ListItem onClick={() => browserHistory.push("/jackpot")}>
          ...
          <ListItemText
            primary="Win the Jackpot"
            secondary="Win the Jackpot today"
          />
        </ListItem>
        <ListItem onClick={() => browserHistory.push("/match-the-pair")}>
          ...
          <ListItemText
            primary="Match the pair"
            secondary="Let's do match-making"
          />
        </ListItem>
